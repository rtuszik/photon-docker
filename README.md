...
| `FILE_URL`             | URL to a .tar.bz2/.jsonl.zst file                     | -                                | Set a custom URL for the index file to be downloaded (e.g., "https://download1.graphhopper.com/public/experimental/photon-db-latest.tar.bz2"). This must be a tar.bz2 or jsonl.zst format. Make sure to set the `UPDATE_STRATEGY` to `DISABLED` when using this option.                |
| `PHOTON_PARAMS`        | Photon executable parameters                          | -                                | See `https://github.com/komoot/photon#running-photon.`                                                                                                                                                                                                                                 |
| `BUILD_PHOTON_PARAMS`  | Photon executable parameters for jsonl.zst extraction | `-languages en,de,fr,es,it`      | See `https://github.com/komoot/photon#importing-data-from-a-json-dump.`                                                                                                                                                                                                                |
